...
public class DBHandler {
    ...
    public static TrilaterationTest retrieveData(Database db) throws Exception
    {
        ...
        for (int i = size.get(0) - 10; i <= size.get(0); i++) {
            ...
            rssi1 = RSSItoDistance.radialScale(radialDistance) * RSSItoDistance.calculateDistance(rssi1);
            //System.out.println(rssi1);
            ...
            rssi2 = RSSItoDistance.radialScale(radialDistance) * RSSItoDistance.calculateDistance(rssi2);
            //System.out.println(rssi2);
            ...
            rssi3 = RSSItoDistance.radialScale(radialDistance) * (RSSItoDistance.calculateDistance(rssi3));
            //System.out.println(rssi3);
